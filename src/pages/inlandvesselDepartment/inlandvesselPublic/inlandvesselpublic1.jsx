...
const initialData = [
  { id: 1, srNo: 1, portGroup: "Bandra", "2022-23": 349, "2023-24": 511, "2024-25": 606 },
  { id: 2, srNo: 2, portGroup: "Mora", "2022-23": 233, "2023-24": 281, "2024-25": 318 },
  { id: 3, srNo: 3, portGroup: "Rajpuri", "2022-23": 292, "2023-24": 296, "2024-25": 253 },
  { id: 4, srNo: 4, portGroup: "Ratnagiri", "2022-23": 50, "2023-24": 59, "2024-25": 75 },
  { id: 5, srNo: 5, portGroup: "Vengurla", "2022-23": 131, "2023-24": 216, "2024-25": 219 }
];

const yearColumns = ["2022-23", "2023-24", "2024-25"];

const InlandVesselPublic = () => {
  ...
  const filtered = useMemo(() => {
    ...
    if (!q) return data;
    return data.filter((row) => row.portGroup.toLowerCase().includes(q));
  }, [query, data]);
    ...
    <div className="max-w-7xl mx-auto p-6">
      <div className="mb-6">
        ...
        <p className="text-slate-600 text-lg font-semibold">
          Port Group Wise Survey Information
        </p>
      </div>
...
export default InlandVesselPublic;
