...
const initialData = [
	{ id: 1, srNo: 1, location: "Bandra Worli Sea Link Jetty", portLimit: "Bandra Port", revenue: { "2022-2023": 609444, "2023-2024": 670383, "2024-2025": 2458900 }, total: 3738727 },
	{ id: 2, srNo: 2, location: "Juhu To Versova Koliwad Beach", portLimit: "Bandra Port", revenue: { "2022-2023": 315747, "2023-2024": 347280, "2024-2025": 1273604 }, total: 1936631 },
	{ id: 3, srNo: 3, location: "Bandra Worli Seaface", portLimit: "Bandra Port", revenue: { "2022-2023": 736848, "2023-2024": 0, "2024-2025": 0 }, total: 736848 },
	{ id: 4, srNo: 4, location: "Kongaon", portLimit: "Bhiwandi", revenue: { "2022-2023": 30680, "2023-2024": "Nil", "2024-2025": "Nil" }, total: 30680 },
	{ id: 5, srNo: 5, location: "Kongaon", portLimit: "Bhiwandi", revenue: { "2022-2023": 17700, "2023-2024": "Nil", "2024-2025": "Nil" }, total: 17700 },
	{ id: 6, srNo: 6, location: "Suruchi Baug", portLimit: "Vasai", revenue: { "2022-2023": "Nil", "2023-2024": 4720, "2024-2025": "Nil" }, total: 4720 },
	{ id: 7, srNo: 7, location: "Suruchi Baug", portLimit: "Vasai", revenue: { "2022-2023": "Nil", "2023-2024": 4720, "2024-2025": "Nil" }, total: 4720 },
	{ id: 8, srNo: 8, location: "Bhuigaon Beach", portLimit: "Vasai", revenue: { "2022-2023": "Nil", "2023-2024": 14160, "2024-2025": "Nil" }, total: 14160 },
	{ id: 9, srNo: 9, location: "Suruchi Baug", portLimit: "Vasai", revenue: { "2022-2023": "Nil", "2023-2024": 4720, "2024-2025": "Nil" }, total: 4720 },
	{ id: 10, srNo: 10, location: "Bhuigaon Beach", portLimit: "Vasai", revenue: { "2022-2023": "Nil", "2023-2024": 4720, "2024-2025": "Nil" }, total: 4720 },
	{ id: 11, srNo: 11, location: "Bhuigaon Beach", portLimit: "Vasai", revenue: { "2022-2023": "Nil", "2023-2024": 4720, "2024-2025": "Nil" }, total: 4720 },
	{ id: 12, srNo: 12, location: "Bhuigaon Beach", portLimit: "Vasai", revenue: { "2022-2023": "Nil", "2023-2024": 4720, "2024-2025": "Nil" }, total: 4720 },
	{ id: 13, srNo: 13, location: "Bhuigaon Beach", portLimit: "Vasai", revenue: { "2022-2023": "Nil", "2023-2024": "Nil", "2024-2025": "4720" }, total: 4720 },
	{ id: 14, srNo: 14, location: "Pachu Bunder", portLimit: "Vasai", revenue: { "2022-2023": "Nil", "2023-2024": "Nil", "2024-2025": 4720 }, total: 4720 }
];

const revenueYears = ["2022-2023", "2023-2024", "2024-2025"];
...
const AdvertisementRevenue = () => {
	...
	const totals = useMemo(() => {
		...
		revenueYears.forEach(year => {
			totalObj[year] = filtered.reduce((sum, row) => sum + (row.revenue[year] === "Nil" ? 0 : (parseInt(row.revenue[year]) || 0)), 0);
		});
		totalObj.grand = filtered.reduce((sum, row) => sum + (row.total === "Nil" ? 0 : (parseInt(row.total) || 0)), 0);
		return totalObj;
	}, [filtered]);
				...
				<table className="w-full text-left align-middle min-w-[1000px] border border-slate-300">
					<thead className="bg-gradient-to-r from-[#dcf2ff] to-sky-100/70 text-slate-700 text-xs uppercase tracking-wide">
						<tr>
							...
							<th className="px-4 py-3 text-center border border-slate-300" colSpan={revenueYears.length}>REVENUE GENERATION</th>
							<th className="px-4 py-3 whitespace-nowrap w-[120px] border border-slate-300">TOTAL</th>
					...
					<tbody className="bg-white">
						{filtered.map((row, idx) => (
							<tr key={row.id} className={`transition-colors group ${idx % 2 === 0 ? 'bg-white' : 'bg-sky-50/40'} hover:bg-sky-50/70`}>
								...
								<td className="px-4 py-3 text-center border border-slate-300 font-semibold text-slate-900">
									{editingId === row.id ? (
										<input type="number" value={editData.total ?? row.total} onChange={e => setEditData(prev => ({ ...prev, total: e.target.value }))} className="w-full px-2 py-1 text-sm border border-black rounded bg-white text-black focus:ring-2 focus:ring-sky-100 focus:border-sky-300 text-center" />
									) : row.total}
								</td>
						...
						<tr className="font-bold bg-slate-100">
							<td className="px-4 py-3 text-slate-900 font-bold text-center border border-slate-300">Advertisement Grand Total</td>
							<td className="px-4 py-3 text-slate-900 font-bold border border-slate-300" colSpan={2}></td>
							{revenueYears.map(year => (
								<td key={year} className="px-4 py-3 text-slate-900 font-bold text-center border border-slate-300">{totals[year]}</td>
							))}
							<td className="px-4 py-3 text-slate-900 font-bold text-center border border-slate-300">{totals.grand}</td>
							<td className="px-4 py-3 text-center border border-slate-300"></td>
						</tr>
						{filtered.length === 0 && (
							<tr>
								<td colSpan={5 + revenueYears.length} className="px-4 py-8 text-center bg-white">
