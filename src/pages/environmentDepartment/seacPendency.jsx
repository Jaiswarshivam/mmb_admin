...
// --- Initial Data based on the SEIAA Pendency image (District-based) ---
const initialData = [
  { id: 1, srNo: 1, district: "Thane", pendingProposal: 0, upto3: "", threeSix: "", sixNine: "", nineTwelve: "", twelveOne: "", oneTwo: "", moreTwo: "" },
  { id: 2, srNo: 2, district: "Sindhudurg", pendingProposal: 0, upto3: "", threeSix: "", sixNine: "", nineTwelve: "", twelveOne: "", oneTwo: "", moreTwo: "" },
  { id: 3, srNo: 3, district: "Raigad", pendingProposal: 0, upto3: "", threeSix: "", sixNine: "", nineTwelve: "", twelveOne: "", oneTwo: "", moreTwo: "" },
  { id: 4, srNo: 4, district: "Ratnagiri", pendingProposal: 0, upto3: "", threeSix: "", sixNine: "", nineTwelve: "", twelveOne: "", oneTwo: "", moreTwo: "" },
  { id: 5, srNo: 5, district: "Palghr", pendingProposal: 0, upto3: "", threeSix: "", sixNine: "", nineTwelve: "", twelveOne: "", oneTwo: "", moreTwo: "" },
  { id: 6, srNo: 6, district: "Mumbai suburban and district", pendingProposal: 0, upto3: "", threeSix: "", sixNine: "", nineTwelve: "", twelveOne: "", oneTwo: "", moreTwo: "" },
];

// Columns for the pendency timeline
...
const SEIAAPendency = () => {
  ...
  const [showAddColumnModal, setShowAddColumnModal] = useState(false); // Modal for adding dynamic column (not used in current JSX, but kept for future dynamic feature)
  ...
  // Add new column logic (kept for potential future use)
  ...
  // Removed AddRowModal component and all leftover code
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 transition-opacity">
        <div className="bg-white rounded-xl p-6 max-w-md w-full mx-4 shadow-2xl scale-100">
          ...
          <p className="text-slate-700 mb-6 pl-12">
            Are you sure you want to delete the entry for **{districtName}** from the SEIAA Pendency table?
          </p>
  ...
  return (
      ...
      {/* Modals */}
      {/* Removed AddRowModal from render tree */}
