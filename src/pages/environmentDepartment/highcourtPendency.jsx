...
// --- Initial Data based on the uploaded "6. High court pendency" image ---
// Rows 2 and 3 had blank districts in the source image, so generic names are used.
const initialData = [
  { id: 1, srNo: 1, district: "Thane", pendingProposal: 1, upto3: "", threeSix: "", sixNine: 1, nineTwelve: "", twelveOne: "", oneTwo: "", moreTwo: "" },
  { id: 2, srNo: 2, district: "", pendingProposal: 1, upto3: "", threeSix: "", sixNine: 1, nineTwelve: "", twelveOne: "", oneTwo: "", moreTwo: "" },
  { id: 3, srNo: 3, district: "", pendingProposal: 1, upto3: "", threeSix: "", sixNine: 1, nineTwelve: "", twelveOne: "", oneTwo: "", moreTwo: "" },
];
    ...
    <div className="max-w-7xl mx-auto p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-slate-900 mb-2">
          6. High Court Pendency
        </h1>
        <p className="text-slate-600">
          Track pending proposals across different districts and their pendency timelines, based on High Court data.
        </p>
      </div>
