...
const initialData = [
  { id: 1, srNo: 1, postName: "Naik", sanctioned: 9, regular: 1, deputed: 0, contractual: 0, filled: 1, vacant: 8 },
  { id: 2, srNo: 2, postName: "Peon / Chowkidar", sanctioned: 108, regular: 51, deputed: 0, contractual: 1, filled: 52, vacant: 56 },
  { id: 3, srNo: 3, postName: "Deckhand", sanctioned: 11, regular: 2, deputed: 0, contractual: 0, filled: 2, vacant: 9 },
  { id: 4, srNo: 4, postName: "Khalashi", sanctioned: 71, regular: 6, deputed: 0, contractual: 0, filled: 6, vacant: 65 },
  { id: 5, srNo: 5, postName: "Sweeper", sanctioned: 0, regular: 0, deputed: 0, contractual: 3, filled: 3, vacant: "-" }
];

const totalRow = {
  srNo: 5,
  postName: "Total Class IV Posts",
  sanctioned: 199,
  regular: 60,
  deputed: 0,
  contractual: 4,
...
const Class4 = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-slate-900 mb-2 ">Status of Posts - Class IV</h1>
      </div>
          ...
          <tbody className="bg-white">
            {data.map((row, idx) => (
              <tr key={row.id} className={`transition-colors group ${idx % 2 === 0 ? 'bg-white' : 'bg-sky-50/40'} hover:bg-sky-50/70`}>
                ...
                <td className="px-4 py-3 border border-slate-300 text-center text-black">
                  {editingId === row.id ? (
                    <input type="text" value={editData.vacant} onChange={e => setEditData(prev => ({ ...prev, vacant: e.target.value }))} className="w-full px-2 py-1 text-sm border border-black rounded bg-white text-black focus:ring-2 focus:ring-red-100 focus:border-red-300 text-center" />
                  ) : (
