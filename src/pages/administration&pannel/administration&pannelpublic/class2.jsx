...
const initialData = [
  { id: 1, srNo: 1, postName: "Administrative Officer", sanctioned: 6, regular: 4, deputed: 0, contractual: 0, filled: 4, vacant: 2 },
  { id: 2, srNo: 2, postName: "Accounts Officer", sanctioned: 1, regular: 0, deputed: 1, contractual: 0, filled: 1, vacant: 0 },
  { id: 3, srNo: 3, postName: "Assistant Secretary / Law Officer", sanctioned: 1, regular: 1, deputed: 0, contractual: 0, filled: 1, vacant: 0 },
  { id: 4, srNo: 4, postName: "Section Engineer", sanctioned: 1, regular: 1, deputed: 0, contractual: 0, filled: 1, vacant: 0 },
  { id: 5, srNo: 5, postName: "Cartographer", sanctioned: 1, regular: 1, deputed: 0, contractual: 0, filled: 1, vacant: 0 },
  { id: 6, srNo: 6, postName: "Assistant Hydrographic Surveyor", sanctioned: 4, regular: 0, deputed: 0, contractual: 0, filled: 0, vacant: 4 },
  { id: 7, srNo: 7, postName: "Section Engineer / Assistant Engineer (Grade-II)", sanctioned: 12, regular: 8, deputed: 0, contractual: 0, filled: 8, vacant: 4 }
];

const totalRow = {
  srNo: 7,
  postName: "Total Class II Posts",
  sanctioned: 26,
  regular: 15,
  deputed: 1,
  contractual: 0,
...
const Class2 = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-slate-900 mb-2 ">Status of Posts - Class II</h1>
      </div>
