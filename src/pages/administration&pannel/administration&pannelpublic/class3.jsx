...
const initialData = [
  { id: 1, srNo: 1, postName: "Stenographer (H.G.)", sanctioned: 2, regular: 1, deputed: 0, contractual: 0, filled: 1, vacant: 1 },
  { id: 2, srNo: 2, postName: "Stenographer (J.G.)", sanctioned: 2, regular: 0, deputed: 0, contractual: 0, filled: 0, vacant: 2 },
  { id: 3, srNo: 3, postName: "Port Superintendent", sanctioned: 10, regular: 8, deputed: 0, contractual: 0, filled: 8, vacant: 2 },
  { id: 4, srNo: 4, postName: "Port Inspector", sanctioned: 60, regular: 48, deputed: 0, contractual: 2, filled: 50, vacant: 10 },
  { id: 5, srNo: 5, postName: "Assistant Port Inspector", sanctioned: 56, regular: 30, deputed: 0, contractual: 0, filled: 30, vacant: 26 },
  { id: 6, srNo: 6, postName: "Junior Clerk", sanctioned: 8, regular: 0, deputed: 0, contractual: 0, filled: 0, vacant: 8 },
  { id: 7, srNo: 7, postName: "Deputy Accountant", sanctioned: 8, regular: 0, deputed: 7, contractual: 0, filled: 7, vacant: 1 },
  { id: 8, srNo: 8, postName: "Vessel Inspector", sanctioned: 2, regular: 0, deputed: 0, contractual: 0, filled: 0, vacant: 2 },
  { id: 9, srNo: 9, postName: "Junior Engineer", sanctioned: 18, regular: 0, deputed: 0, contractual: 0, filled: 0, vacant: 18 },
  { id: 10, srNo: 10, postName: "Assistant Planner", sanctioned: 1, regular: 0, deputed: 0, contractual: 0, filled: 0, vacant: 1 },
  { id: 11, srNo: 11, postName: "Driver", sanctioned: 12, regular: 5, deputed: 0, contractual: 1, filled: 6, vacant: 6 },
  { id: 12, srNo: 12, postName: "Draftsman", sanctioned: 1, regular: 1, deputed: 0, contractual: 0, filled: 1, vacant: 0 },
  { id: 13, srNo: 13, postName: "Assistant Draftsman", sanctioned: 3, regular: 1, deputed: 0, contractual: 0, filled: 1, vacant: 2 },
  { id: 14, srNo: 14, postName: "Electronic Assistant", sanctioned: 1, regular: 0, deputed: 0, contractual: 0, filled: 0, vacant: 1 },
  { id: 15, srNo: 15, postName: "Survey Assistant", sanctioned: 12, regular: 3, deputed: 0, contractual: 0, filled: 3, vacant: 9 },
  { id: 16, srNo: 16, postName: "Tandel", sanctioned: 10, regular: 0, deputed: 0, contractual: 0, filled: 0, vacant: 10 },
  { id: 17, srNo: 17, postName: "Dredger Master / Operator", sanctioned: 2, regular: 0, deputed: 0, contractual: 0, filled: 0, vacant: 2 },
  { id: 18, srNo: 18, postName: "Crane Operator", sanctioned: 2, regular: 2, deputed: 0, contractual: 0, filled: 2, vacant: 0 },
  { id: 19, srNo: 19, postName: "Dredger Engineer", sanctioned: 2, regular: 0, deputed: 0, contractual: 0, filled: 0, vacant: 2 },
  { id: 20, srNo: 20, postName: "Master / Sarang (Boat Master)", sanctioned: 13, regular: 4, deputed: 0, contractual: 0, filled: 4, vacant: 9 },
  { id: 21, srNo: 21, postName: "Engine Operator", sanctioned: 13, regular: 4, deputed: 0, contractual: 0, filled: 4, vacant: 9 },
  { id: 22, srNo: 22, postName: "Circle Officer", sanctioned: 1, regular: 0, deputed: 0, contractual: 0, filled: 0, vacant: 1 },
  { id: 23, srNo: 23, postName: "Light Mechanic", sanctioned: 1, regular: 0, deputed: 0, contractual: 0, filled: 0, vacant: 1 },
  { id: 24, srNo: 24, postName: "Senior Field Assistant", sanctioned: 6, regular: 0, deputed: 0, contractual: 0, filled: 0, vacant: 6 },
  { id: 25, srNo: 25, postName: "Oiler / Greaser", sanctioned: 12, regular: 3, deputed: 0, contractual: 0, filled: 3, vacant: 9 },
  { id: 26, srNo: 26, postName: "Mechanical Oversear", sanctioned: 2, regular: 1, deputed: 0, contractual: 0, filled: 1, vacant: 1 }
];

const totalRow = {
  srNo: 26,
  postName: "Total Class III Posts",
  sanctioned: 260,
  regular: 111,
  deputed: 7,
  contractual: 3,
...
const Class3 = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-slate-900 mb-2 ">Status of Posts - Class III</h1>
      </div>
